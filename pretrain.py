...
def main():
    ...
    # Model options.
    model_opts(parser)
    parser.add_argument("--data_processor", choices=["bert", "lm", "mlm", "bilm", "albert", "mt", "t5", "cls", "prefixlm", "gsg", "bart", "cls_mlm"], default="mlm",
    ...
    # weight squeeze options
    parser.add_argument("--weight_squeeze", action="store_true", help=".")
    parser.add_argument("--compactor_learning_rate", type=float, default=5e-5,
                        help=".")
    parser.add_argument("--w_step", type=int, default=1000,
                        help=".")
    parser.add_argument("--target_dim", type=int, default=512,
                        help=".")
    parser.add_argument("--l2_lambda", type=float, default=20.0,
                        help=".")
    parser.add_argument("--compactor_mask_strategy",choices=["head", "dim"], default="dim",
                        help=".")
    parser.add_argument("--comp_only", action="store_true", help=".")
    parser.add_argument("--print_ins_log", action="store_true", help=".")
    parser.add_argument("--tb_path", type=str, required=True, help="path to record logs")
    parser.add_argument("--mask_path", type=str, required=True, help="path to record mask dim")
    # Deepspeed options.
